...
//	private void addShortcut(String contactName, String phoneNumber, 
...
//		Log.i(MainActivity.TAG, "Addedd shortcut to call app: " + className + 
...
//	private void addShortcut(String contactName, String phoneNumber) {
//		Log.i(MainActivity.TAG, "Addedd shortcut to default call app, " + 
//								"contactName: " + contactName + 
//								", phoneNumber: " + phoneNumber);
//		Uri numberUri = Uri.parse("tel:" + phoneNumber);
//		Intent callIntent = new Intent(Intent.ACTION_CALL, numberUri);
...
//		addIntent.putExtra(Intent.EXTRA_SHORTCUT_NAME, "OneClickCallShortcut");
//
